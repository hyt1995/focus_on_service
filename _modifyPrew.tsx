// function dfsdf() {
//  return (
//     <div className="w-full xl:w-[380px] h-[80vh] overflow-y-auto p-6 bg-white rounded-3xl shadow-xl border border-gray-100 shrink-0 space-y-8">
...
//           max="1000"
//           value={logoPos.t}
//           onChange={e => setLogoPos({ ...logoPos, t: Number(e.target.value) })}
//           className="flex-1"
//         />
