...
const CalendarView: React.FC<Props> = ({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-6 animate-in fade-in duration-300 pb-20">
      ...
      {/* 🌟 3. 오리지널 Tailwind 모달 (TDS 삭제 완료 버전) */}
      {!!selectedDate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-[32px] w-full max-w-md shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="flex flex-col max-h-[85vh] p-6 pb-8">
              {/* 헤더 영역 */}
                ...
                {isAdding ? (
                  ...
                  <div className="animate-in fade-in duration-300 space-y-3">
                    ...
                    <div className="flex gap-3 mt-6 pt-4">
                      ...
                      <button
                        onClick={handleSave}
                        className="flex-1 py-4 bg-[#3182F6] text-white font-bold rounded-2xl hover:bg-blue-600 active:scale-95 transition-all shadow-md shadow-blue-200"
                      >
                        {editingId ? "수정하기" : "저장하기"}
                      </button>
                    </div>
